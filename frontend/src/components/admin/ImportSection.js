      ...
      <div className="admin-section">
        ...
        <div className="import-box">
          <p className="import-desc">
            Upload an Excel file (.xlsx) containing all trade data (historical + new).
            This will replace all existing trade records.
          </p>
          <div className="import-row">
            <label className="file-label">
              ...
              <span className="file-name">{importFile ? importFile.name : "No file chosen"}</span>
            </label>
            <button
